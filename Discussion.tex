...
\subsection{Connecting with numerical simulations}
...
\noindent $\bullet$ Cloud rotation speed (Fig.~\ref{Fig:compRot}). \\
The overall rotation speed in the core determines the magnitude of specific 
angular momentum. As shown in Fig.~\ref{Fig:compRot}, at a similar evolution
epoch (similar density profile, not plotted), 
the specific angular momentum curve is higher for faster rotating core. 
The observed j-profile lies largely in between the $\beta=0.05$ and $\beta=0.2$ 
models, and the curve is much closer to the fastest rotating model $\beta=0.2$. 
Therefore, we infer the three observed sources tend to have $\beta\sim0.2$, which
